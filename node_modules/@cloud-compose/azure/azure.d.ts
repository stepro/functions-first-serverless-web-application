...
export interface ResourceProperties extends compose.Properties {
    resourceName?: string;
...
export interface ResourceSpec<T extends Resource<T, S, P>, S extends ResourceSpec<T, S, P> & P, P extends ResourceProperties> extends ResourceProperties, compose.Spec<T, S, P> {
